...
public enum ParticleEffect
{
	...
	BLOCK_MARKER("BLOCK_MARKET", Collections.singletonList("STONE"), ParticleProperty.REQUIRES_MATERIAL_DATA),
	...
	CHERRY_LEAVES("CHERRY_LEAVES", Collections.singletonList("CHERRY_LOG")),
	...
	DUST("DUST", Collections.singletonList("REDSTONE"), ParticleProperty.COLORABLE),
	DUST_COLOR_TRANSITION("DUST_COLOR_TRANSITION", Collections.singletonList("REDSTONE"), ParticleProperty.DUST_TRANSITION),
	DUST_PILLAR("DUST_PILLAR", Collections.singletonList("GLOWSTONE_DUST"), ParticleProperty.REQUIRES_MATERIAL_DATA),
	DUST_PLUME("DUST_PLUME", Collections.singletonList("GUNPOWDER")),
	EFFECT("EFFECT", Collections.singletonList("BLAZE_POWDER")),
	...
	FALLING_DRIPSTONE_LAVA("FALLING_DRIPSTONE_LAVA", Collections.singletonList("DRIPSTONE_BLOCK")),
	FALLING_DRIPSTONE_WATER("FALLING_DRIPSTONE_WATER", Collections.singletonList("DRIPSTONE_BLOCK")),
	...
	FALLING_SPORE_BLOSSOM("FALLING_SPORE_BLOSSOM", Collections.singletonList("SPORE_BLOSSOM")),
	...
	GLOW("GLOW", Collections.singletonList("GLOWSTONE")),
	GLOW_SQUID_INK("GLOW_SQUID_INK", Collections.singletonList("GLOW_INK_SAC")),
	GUST("GUST", Collections.singletonList("WHITE_BANNER")),
	GUST_EMITTER_LARGE("GUST_EMITTER_LARGE", Collections.singletonList("WHITE_BANNER")),
	GUST_EMITTER_SMALL("GUST_EMITTER_SMALL", Collections.singletonList("WHITE_BANNER")),
	...
	INFESTED("INFESTED", Collections.singletonList("INFESTED_CRACKED_STONE_BRICKS")),
	...
	ITEM_COBWEB("ITEM_COBWEB", Collections.singletonList("COBWEB")),
	...
	OMINOUS_SPAWNING("OMINOUS_SPAWNING", Collections.singletonList("GRAY_BANNER")),
	...
	RAID_OMEN("RAID_OMEN", Collections.singletonList("RED_BANNER")),
	...
	SCRAPE("SCRAPE", Collections.singletonList("IRON_SHOVEL")),
	SCULK_CHARGE("SCULK_CHARGE", Collections.singletonList("SCULK_SENSOR"), ParticleProperty.FLOAT),
	SCULK_CHARGE_POP("SCULK_CHARGE_POP", Collections.singletonList("CALIBRATED_SCULK_SENSOR")),
	SCULK_SOUL("SCULK_SOUL", Collections.singletonList("SCULK")),
	SHRIEK("SHRIEK", Collections.singletonList("SCULK_SHRIEKER"), ParticleProperty.INTEGER),
	SMALL_FLAME("SMALL_FLAME", Collections.singletonList("TORCH")),
	SMALL_GUST("SMALL_GUST", Collections.singletonList("WHITE_BANNER")),
	SMOKE("SMOKE_NORMAL", Collections.singletonList("TORCH")),
	SNEEZE("SNEEZE", Collections.singletonList("BAMBOO")),
    SNOWFLAKE("SNOWFLAKE", Arrays.asList("SNOWBALL", "SNOW_BALL")),
    SONIC_BOOM("SONIC_BOOM", Collections.singletonList("DIAMOND_AXE")),
    ...
    TRIAL_OMEN("TRIAL_OMEN", Collections.singletonList("BLUE_BANNER")),
    TRIAL_SPAWNER_DETECTION("TRIAL_SPAWNER_DETECTION", Collections.singletonList("GREEN_BANNER")),
    TRIAL_SPAWNER_DETECTION_OMINOUS("TRIAL_SPAWNER_DETECTION_OMINOUS", Collections.singletonList("BROWN_BANNER")),
	UNDERWATER("SUSPENDED_DEPTH", Arrays.asList("TURTLE_HELMET", "SPONGE")),
    VAULT_CONNECTION("VAULT_CONNECTION", Collections.singletonList("IRON_DOOR")),
    VIBRATION("VIBRATION", Collections.singletonList("VIBRATION"), ParticleProperty.VIBRATION),
	WARPED_SPORE("WARPED_SPORE", Collections.singletonList("WARPED_FUNGUS")),
    WAX_OFF("WAX_OFF", Collections.singletonList("HONEYCOMB")),
    WAX_ON("WAX_ON", Collections.singletonList("HONEY_BOTTLE")),
	WHITE_ASH("WHITE_ASH", Collections.singletonList("BASALT")),
    WHITE_SMOKE("WHITE_SMOKE", Collections.singletonList("CAMPFIRE")),
	...
	public static void display(ParticlePair particle, PParticle pparticle, boolean isLongRange, Player owner)
	{
		...
		} else if (effect.hasProperty(ParticleProperty.DUST_TRANSITION)) {
            effect.display(particle.getFromColor(), particle.getToColor(), particle.getSize(), pparticle.getXOff(), pparticle.getYOff(), pparticle.getZOff(), particle.getParticleSpeed() > -1 ? particle.getParticleSpeed() : pparticle.getSpeed(), count, pparticle.getLocation(false), isLongRange, owner);
        } else if (effect.hasProperty(ParticleProperty.FLOAT)) {
			effect.display(particle.getF(), pparticle.getXOff(), pparticle.getYOff(), pparticle.getZOff(), count, pparticle.getLocation(false), isLongRange, owner);
		} else if (effect.hasProperty(ParticleProperty.INTEGER)) {
			effect.display(particle.getI(), pparticle.getXOff(), pparticle.getYOff(), pparticle.getZOff(), count, pparticle.getLocation(false), isLongRange, owner);
    ...
    public void display(Color fromColor, Color toColor, float size, double offsetX, double offsetY, double offsetZ, double speed, int amount, Location center, boolean isLongRange, Player owner)
    {
        particleSpawner.display(this, fromColor, toColor, size, offsetX, offsetY, offsetZ, speed, amount, center, isLongRange, owner);
    }
	...
	public enum ParticleProperty
	{
		...
		COLORABLE,
		/**
		 * The particle effect requires start and end colours to perform a gradient animation over
		 */
		DUST_TRANSITION,
		FLOAT,
		INTEGER,
